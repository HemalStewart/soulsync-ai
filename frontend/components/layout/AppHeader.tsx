...
>
  {/* Logo Image */}
  <div className="relative flex h-7 w-7 sm:h-9 sm:w-9 items-center justify-center rounded-xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 p-[3px] shadow-brand hover:scale-105 transition-transform duration-200">
